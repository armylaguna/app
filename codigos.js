// ============================================================
// AYUDANTES DE ROL — Ejército de Laguna
// ============================================================
...
// NOTA: por ahora solo queda habilitada "Academia Militar". Las demás
// divisiones (O.P.E., SWAT, Centro de Mando, Reclutamiento, BodyCams) se
// retiraron temporalmente de esta lista — el Ejército va a tener sus
// propias divisiones/unidades más adelante, pero mientras tanto solo se
// necesita Academia Militar. Para reactivar una división alcanza con
// agregarla de nuevo acá y a PUESTOS_POR_DIVISION más abajo.
...
// Reclutamiento, supervisor en BodyCams). Academia Militar es la única
...
const PUESTOS_POR_DIVISION = {
  ...
  // Divisiones retiradas por ahora (O.P.E., SWAT, Centro de Mando,
  // Reclutamiento, BodyCams) — se sacaron de DIVISIONES_ROL más arriba, así
  // que estas entradas ya no se usan, pero se dejan comentadas para cuando
  // el Ejército tenga sus propias divisiones/unidades:
  //
  // "División O.P.E.": [
  //   { valor: "lider", etiqueta: "líder" },
  //   { valor: "sublider", etiqueta: "sublíder" },
...
// división Academia Militar (ver PUESTOS_POR_DIVISION arriba).
...
// La división "Academia Militar" es la única cuyo líder/sublíder
...
// antes es "líder"/"sublíder" de Academia Militar); recién ahí el
...
// administrador, y el liderazgo de Academia Militar) siguen pudiendo
