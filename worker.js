...
// NOTA: por ahora solo Academia Militar. Las demás (O.P.E., SWAT, Centro
// de Mando, Reclutamiento, BodyCams) se retiraron temporalmente — el
// Ejército va a tener sus propias divisiones/unidades más adelante.
...
const NOTICIAS_SEED = [
  {
    id: "noticia_seed_1",
    division: "Academia Militar",
    texto: "🚨 Bienvenidos a la sección de Noticias del Ejército de Laguna. Acá vamos a publicar avisos, resultados de operativos y novedades de la Academia. ¡Dejen sus 👍 y comentarios!",
    imagen: "",
    autor: "Academia Militar",
    rol: "administrador",
  ...
  // Las demás divisiones (Centro de Mando, SWAT, O.P.E., Reclutamiento)
  // están retiradas por ahora — cuando el Ejército tenga sus propias
  // divisiones/unidades, se pueden agregar más entradas semilla acá.
];
...
// líder/sublíder de la división "Academia Militar" SÍ heredan el nivel de
...
const DIVISION_CON_LIDERAZGO_ADMIN = "Academia Militar";
...
// puesto cambia según la división. Academia Militar además tiene
...
const PUESTOS_POR_DIVISION = {
  "Academia Militar": ["lider", "sublider", "evaluador", "instructor", "instructor_prueba"],
  // Divisiones retiradas por ahora — reactivar acá y en DIVISIONES_NOTICIAS
  // cuando el Ejército tenga sus propias divisiones/unidades:
...
function nombresDeCodigos(codigos) {
  ...
  // división Academia Militar (para el roster de "Miembros de la Academia
...
async function manejarCodigos(request, env, payload) {
  ...
  if (payload.accion === "guardar") {
    ...
    // prueba dentro de Academia Militar) — separado de los roles
